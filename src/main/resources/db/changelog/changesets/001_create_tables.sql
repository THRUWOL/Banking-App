...
(
    ...
    constraint cars_accounts foreign key (account_id) references accounts (id)
);
...
(
    ...
    constraint transactions_card_from foreign key (from_id) references cards (id),
    constraint transactions_card_to foreign key (to_id) references cards (id)
);
